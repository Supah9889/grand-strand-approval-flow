...
export function buildSignatureItem(rec, navigate) {
  ...
  return {
    ...
    hasFile: !!(rec.output_file_url || rec.signed_output_file_url || rec.output_file_r2_key || rec.signed_output_r2_key),
    fileUrl: rec.output_file_url,
    signedFileUrl: rec.signed_output_file_url,
    fileR2Key: rec.signed_output_r2_key || rec.output_file_r2_key,
    jobId: rec.job_id,
    fileCategory: 'signed_doc',
    filePurpose: 'preview_signature_timeline_output',
