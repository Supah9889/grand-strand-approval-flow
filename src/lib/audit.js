...
export const ACTION_LABELS = {
  ...
  legacy_manual_job_created:        { label: 'Legacy Job Added Manually',         color: 'text-primary' },
  legacy_cutover_prepared:          { label: 'Legacy Job Cutover Prepared',       color: 'text-cyan-600' },
  legacy_cutover_completed:         { label: 'Legacy Job Cutover Complete',       color: 'text-green-600' },
  legacy_duplicate_flagged:         { label: 'Legacy Duplicate Flagged',          color: 'text-yellow-600' },
  legacy_live_duplicate_flagged:    { label: 'Legacy Live Duplicate Flagged',      color: 'text-yellow-600' },
  legacy_cutover_auto_verified:     { label: 'Legacy Cutover Auto-Verified',       color: 'text-green-600' },
  proven_jobs_checklist_created:    { label: 'Export Checklist Created',           color: 'text-primary' },
  proven_jobs_checklist_updated:    { label: 'Export Checklist Updated',           color: 'text-foreground' },
  proven_jobs_checklist_completed:  { label: 'Export Checklist Completed',         color: 'text-green-600' },
  proven_jobs_checklist_archived:   { label: 'Export Checklist Archived',          color: 'text-amber-600' },
  rollout_checklist_created:        { label: 'Rollout Checklist Created',          color: 'text-primary' },
  rollout_checklist_updated:        { label: 'Rollout Checklist Updated',          color: 'text-foreground' },
  rollout_status_changed:           { label: 'Rollout Status Changed',             color: 'text-amber-600' },
  review_feedback_status_changed:   { label: 'Review Feedback Status Changed',     color: 'text-foreground' },
  review_feedback_sent_to_nexus:    { label: 'Review Feedback → Nexus',            color: 'text-purple-600' },
  review_decision_created:          { label: 'Review Decision Created',            color: 'text-primary' },
  review_decision_updated:          { label: 'Review Decision Updated',            color: 'text-foreground' },
